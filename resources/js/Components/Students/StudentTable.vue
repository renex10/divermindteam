    ...
    <table class="min-w-full divide-y divide-gray-300">
      ...
      <tbody class="bg-white divide-y divide-gray-200">
        ...
        <tr v-for="student in studentsData" :key="student.id" class="hover:bg-gray-50">
          ...
          <!-- ID del documento -->
          <td class="px-6 py-4 whitespace-nowrap">
            <div class="text-sm text-gray-900">{{ student.document_id || 'N/A' }}</div>
          </td>
          
          <!-- Fecha de nacimiento formateada -->
          <td class="px-6 py-4 whitespace-nowrap">
            <div class="text-sm text-gray-900">
              {{ student.birth_date_formatted || formatDate(student.birth_date) }}
              <div v-if="student.age" class="text-xs text-gray-500">{{ student.age }} años</div>
            </div>
          </td>
...
const props = defineProps({
  // Los datos de estudiantes pueden venir como array (data) o como objeto paginado
  students: {
    type: [Object, Array],
    required: true
  }
